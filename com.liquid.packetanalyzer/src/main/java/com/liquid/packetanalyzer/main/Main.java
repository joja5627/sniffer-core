...
package com.liquid.packetanalyzer.main;
...
//        String validatedArgs = "ValidatedArgs{" +

//        ValidatedArgs validArgs = new ValidatedArgs();
//        validArgs.inputFiles = new LinkedList(new File("/Users/joejackson/Desktop/airplane-capture/capture6.pcap") );
